...
| --- | --- | --- | --- |
| Content and method | package `metadata.version` (repository version `0.1.0`, tag `v0.1.0`); research `skill_revision: intgral-research/<function>@N` (`@2` since INT-725, competitor `@3` since INT-777); `runbook_revision: intgral-research@3` (`@2` since INT-702, `@3` since INT-738); `template_revision: <report_kind>@1`; report `schema_revision: <report_kind>/1` (the package's declaration — the deployed route stores any non-empty string); video `skill_version: intgral-video@3` (`@2` since INT-777, `@3` since INT-799) | the guidance, examples or analysis method change | no |
