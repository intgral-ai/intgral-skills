...
Using the open-source [Skills CLI](https://github.com/vercel-labs/skills):
...
**Initial delivery is a review branch.** Until its PR is merged, use the review-branch URL in the installation guide. The default branch is only a repository bootstrap; no release tag is advertised yet.
